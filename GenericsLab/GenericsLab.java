 ...
 * This doesn't seem useful yet, but in a Collection such as ArrayList, you could have a generic array that can store and retrieve many items of any type. 
 * This feature is needed for collections, web server technologies, and advanced database interactivity (ORMs).
 * *
...
public class GenericsLab<T> {
    private T data; // The object to be stored, of type T

    /**
     * Sets the 'data' field to the object passed as 'in'.
     *
     * @param in an Object that will be of type T at runtime.
     */
    public void loadGenericItem(T in) {
        this.data = in; // Save the passed object into the 'data' field
    }
    ...
    public T returnGenericItem() {
        return this.data; // Return the stored object
    }
}